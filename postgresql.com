...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2021-07-07T20:31:48.258754" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/postgresql-jdbc-42223-released-2257/">PostgreSQL JDBC 42.2.23 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-07-07 by JDBC Project</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_builder-100-and-pg_wrapper-100-packages-for-php-released-2255/">pg_builder 1.0.0 and pg_wrapper 1.0.0 packages for PHP released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-07-06 by Alexey Borzov</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/extension-credcheck-to-enforce-username-and-password-checks-in-postgresql-2254/">Extension : credcheck, to enforce username and password checks in PostgreSQL</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-07-06 by MigOps</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/postgresql-weekly-news-july-4-2021-2256/">PostgreSQL Weekly News - July  4, 2021</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-07-05 by PWN</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/ora2pg-v220-and-221-released-2252/">Ora2Pg v22.0 and 22.1 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2021-07-05 by Gilles Darold</li>
              </ul>
            </li>
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/56P"> The Next Generation of Kubernetes Native Postgres</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/56M"> Paranoid SQL Execution on Postgres</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Jeremy Schneider</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-07-06</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/56L"> Simulating temporal tables with dblink and replication delay</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/56K"> Password Storage Update</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David E. Wheeler</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-07-05</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/56J"> Daniel Westermann</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/56I"> Postgres Permissions and Materialized Views</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/56H"> Buffers I/O information on explain.depesz.com</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Hubert &#39;depesz&#39; Lubaczewski</li>
              <li><i class="far fa-clock"></i>&nbsp;2021-07-04</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/56G"> Disaster Recovery Strategies for PostgreSQL Deployments on Kubernetes (Part 2)</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/56F"> PostGIS 3.1.3</a></h3>
            <ul class="meta">
